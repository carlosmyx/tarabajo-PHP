            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Nueva nivel academico</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="crud_academico.php" method="post">
                            <label for="txt_codigo" class="form-label"> Nivel academico</label>
                            <input type="number" name="txt_codigo" id="txt_codigo" class="form-control">
                            <label class="form-label" for="txt_nombre"> nivel de estudios</label>
                            ...
                            <button type="submit" class="form-control btn btn-primary" name="btn_insertar">
                                Agregar nivel academico</button>
                        </form>
                    </div>
       ...
       ?>
                <tr>
                    ...
                    <td class="d-flex flex-row">
                        <form action="crud_academico.php" method="post" class="me-1">
                        ...
                        <form action="actualizar_nivel_acad.php" method="post">
