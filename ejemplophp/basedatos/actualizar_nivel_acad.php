...
<body>
    ...
    <div class="container">
        <h1>Modificar</h1>
        <!--crud_academico.php es el archivo que realizara los procesos 
        crud en la bd-->
        <form action="crud_academico.php" method="post">
            <label for="txt_codigo" class="form-label">Nuevo nivel academico</label>
            ...
            <button type="submit" class="form-control btn btn-primary"
                ...
                Modificar nivel academico</button>
        </form>
    </div>
