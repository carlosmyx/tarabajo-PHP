...
<div class="regresar-container">
  <a href="index.html" class="btn-regresar">
    ...
    <label for="cod_region" class="form-label">Código de región</label>
    <input type="number" name="cod_region" id="cod_region" class="form-control">
    <label class="form-label" for="nombre_depto">Nombre de departamento</label>
    <input type="text" name="nombre_depto" id="nombre_depto" class="form-control">
    <label for="cod_depto" class="form-label">Código de departamento</label>
    <input type="text" name="cod_depto" id="cod_depto" class="form-control">
       ...
       ?>
                <tr>
                    ...
                    <td class="d-flex flex-row">
                        <form action="crud_departamentos.php" method="post" class="me-1">
                            <input type="hidden" name="hidden_codigo" id="hidden_codigo"
                                value="<?php echo $datos['cod_depto'];?>">
