...
<body>
    ...
    <div class="container">
        ...
        <form action="crud_departamentos.php" method="post">
            <label for="txt_codigo" class="form-label">Nuevo departamento</label>
            <input type="number" name="txt_codigo" id="txt_codigo" 
                value="<?php echo $codigo;?>" class="form-control" 
                readonly>
            <label class="form-label" for="txt_nombre">Nombre del departamento</label>
            <input type="text" name="txt_nombre" id="txt_nombre" 
                value="<?php echo $datos['nombre_depto'];?>" 
                class="form-control">
