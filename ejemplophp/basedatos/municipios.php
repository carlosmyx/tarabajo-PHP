            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Nueva municipio</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="crud_municipios.php" method="post">
                            <label for="txt_codigo" class="form-label">Código de municipio</label>
                            <input type="number" name="txt_codigo" id="txt_codigo" class="form-control">
                            <label class="form-label" for="txt_nombre">Nombre del municipio</label>
                            <input type="text" name="txt_nombre" id="txt_nombre" class="form-control">
                            <label for="txt_desc" class="form-label"> codigo de departamento</label>
       ...
       ?>
                <tr>
                    ...
                    <td class="d-flex flex-row">
                        <form action="crud_municipios.php" method="post" class="me-1">
                        ...
                        <form action="actualizar_municipios.php" method="post">
